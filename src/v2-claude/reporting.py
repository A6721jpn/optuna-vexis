...
def _objective_labels(cfg: V2Config, study: optuna.study.Study) -> list[str]:
...
def _physical_step_for_param(cfg: V2Config, name: str) -> Optional[float]:
...
def generate_markdown_report(
    *,
    ...
    report_path = result_dir / "report_v2.md"
    ...
    lines: list[str] = []
    lines.append("# Production v2 最適化レポート")
    lines.append("")
